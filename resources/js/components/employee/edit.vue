<template>
    <div v-if="fetchEmployee" class="loader"></div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" id="firstName" v-model="form.name" class="form-control"
                                            required="" />
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" id="phonephp" v-model="form.phone" class="form-control"
                                            required="" />
...
export default {
    ...
    created() {
        ...
        this.fetchEmployee = true;
        let id = this.$route.params.id; //--taking id from route/url
        axios
            .get("/api/employee/" + id) //--targeting show() method
            .then(({ data }) => {
                this.form = data
                this.fetchEmployee = false;
            })
            .catch();
    },
    methods: {
        ...
        employeeUpdate() {
            ...
            let id = this.$route.params.id; //--taking id from route/url
            axios
                .patch("/api/employee/" + id, this.form) //--patch will auto call update() mathod
                .then(() => {
