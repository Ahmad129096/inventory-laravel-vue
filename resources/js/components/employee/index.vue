    ...
    <div v-else>
        ...
        <div class="row card container ml-3 border-primary shadow mb-3"> <!-----f----->
            <div class="card-header text-primary" style="font-size: 20px; font-weight:700;">
                ...
                All Employee
                <router-link to="/store-employee" class="btn btn-primary" id="add_new"> Add Employee</router-link>
                <!-----f----->
            </div>
                        ...
                        <table class="table table-bordered table-striped table-hover table-warning border-primary" id=""
                            ...
                            <tbody>
                                <tr v-for="employee in filtersearch" :key="employee.id"> <!-------------------------->
                                    <td>{{ employee.name }}</td>
                                    <td>
                                        <img :src="employee.photo" v-if="employee.photo" id="em_photo">
                                        <img :src="require(`../../contact.png`)" v-else id="em_photo" alt="Image">
                                    </td> <!--bind(:) korle R {{}} lage na-->
