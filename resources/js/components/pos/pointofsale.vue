        ...
        <div class="row mb-4">
            ...
            <div class="card col-lg-5 border-primary shadow">
                ...
                <div class="card-footer">
                    <!-----Expense_Insert_Table(Middle_Left)------->
                    <ul class="list-group">
                        <li
                    ...
                    <br />
                    <!-----Expense_Insert_Table(Bottom_Left)------>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="card-body">
                                                ...
                                                >
                                                <span
                                                    class="text-primary d-block m-0 p-0 small"
                                                >
                                                    BDT:
                                                    {{
        ...
        getfiltersearch() {
            ...
            return this.getproducts.filter(getproduct => {
                ...
                return getproduct.product_name
                    .toLowerCase()
                    .match(this.getsearchTerm.toLowerCase());
            });
        },
        qty() {
            let sum = 0;
